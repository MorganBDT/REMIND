...
EXPT_NAME=remind_squeezenet_imagenet_origpqreshape_run${RUN}
...
NUM_CLASSES=1000
#NUM_CLASSES=104
BASE_INIT_CKPT=./resnet_imagenet_ckpts/best_SqueezeNetClassifyAfterLayer12_base_init_origpqreshape_run${RUN}.pth # base init ckpt file
